...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 25 14:51:58 2018
...
decoder_path = 'checkpoints/model_cuda_30.ckpt'
...
for image in os.listdir(test_image_dir):
    image_path = test_image_dir + image
...
#    attention_visualization(test_image_dir, image, sampled_caption, alphas)
    image = Image.open(image_path)
    print(sentence)
    print(image_path)
